...
####################D√©couper les cartes par rapport aux quartiers de vent###############################
...
liste_metrics=list_lsm() # listes des m√©triques qui existent
as.data.frame(liste_metrics)
liste_metrics #afficher les m√©triques disponibles 
...
mean_ndvi_df=NULL #attention entre plusieurs utilisations il faut remettre ‡ 0 le rÈsultats sinon Áa s'accumule
...
mean_ndvi_df # afficher le r√©sultats 
